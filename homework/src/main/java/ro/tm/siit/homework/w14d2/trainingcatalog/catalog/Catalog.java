 ...
 * 
 */
package ro.tm.siit.homework.w14d2.trainingcatalog.catalog;
...
import ro.tm.siit.homework.w14d2.trainingcatalog.TrainerCatalogInterface;
import ro.tm.siit.homework.w14d2.trainingcatalog.person.Person;
...
public class Catalog implements TrainerCatalogInterface, TraineeCatalogInterface {
	...
	public int getLastGrade(String name) {
		TraineeGrades participant = find(name);
		return participant.grades[participant.grades.length - 1];
	}
