...
public class BankAccount implements Cloneable {
	...
	// synchronized to allow one operation at a time between
	// getBalance/deposit/withdraw for a BankAccount
	...
	// synchronized to allow one operation at a time between
	// getBalance/deposit/withdraw for a BankAccount
	public synchronized float getBalance(Currency ccy) {
	...
	/**
	 * supports saving/exporting a BankAccount
	 * @return a String format for this BankAccount
	 */
	public String toStream() {
		return iban + ":" + ccy + ":" + amount;
	}
